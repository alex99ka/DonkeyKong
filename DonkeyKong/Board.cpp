...
{
	int IndexArr[] = { 1,6,14,24,60,79,1,10,64,79,48,52,60,79,1,8,44,79,1,42,1,14,65,79 }; // even starts the gap and odd ends the gap. between 0 and 6 there will be a gap on the bottom floor
...
void CBoard::FreeListLadderNode(ListOfLadders* lst)
{
	Ladder* node = lst->head;
...
bool CBoard::GetBoardCh(CPoint& coord, char* symbol, CColorPoint::c_color* color)
{
